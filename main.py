...
class RNN:
    ...
    def fit(self, X, Y, learning_rate=1e-4, mu=0.99, epochs=10, show_fig=True, activation=T.nnet.relu,
            RecurrentUnit=GRU, normalize=False):
        D = self.D
        V = self.V
        N = len(X)
